...
function buildDetailTable(cicloData) {
    const rows = [
        ...
        ['Transmisión DIAN', formatDateRange(cicloData.dian_inicio, cicloData.dian_fin)],
        ['Entrega Factura', formatDateRange(cicloData.entrega_cliente_inicio, cicloData.entrega_cliente_fin)],
        ['Pago sin Recargo', formatDateRange(cicloData.pago_inicio, cicloData.pago_fin)],
        ['Suspensión', formatDateRange(cicloData.suspension_inicio, cicloData.suspension_fin)]
    ];
